...
def plot_history(history):
    ...
    if 'psnr' in history.history:
        plt.subplot(1, 3, 2)
        plt.plot(history.history['psnr'], label='Train PSNR', color='green')
        plt.plot(history.history['val_psnr'], label='Validation PSNR', color='red')
    ...
    if 'ssim' in history.history:
        plt.subplot(1, 3, 3)
        plt.plot(history.history['ssim'], label='Train SSIM', color='purple')
        plt.plot(history.history['val_ssim'], label='Validation SSIM', color='pink')
